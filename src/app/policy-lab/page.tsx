...
export default function PolicyLabPage() {
  return (
    <div className="section py-12 sm:py-16">
            ...
            <div key={model.id} className="card p-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <h2 className="mt-1 font-display text-lg font-extrabold text-ink-950">{model.scenario}</h2>
                </div>
              </div>
      ...
      <div className="card mt-10 border-2 border-brand-200 bg-brand-50 p-8">
        <div className="flex items-start gap-4">
