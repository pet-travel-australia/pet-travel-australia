...
export const operatorScores: OperatorScore[] = [
  ...
  },
  {
    ...
    summary: "Cabin access for small pets is clearly documented, but larger dogs are pushed into a separate, costlier freight process.",
  },
  {
    id: "virgin-australia",
    ...
    summary: "No standard passenger pet carriage of any kind — one of the largest gaps of any national carrier.",
  },
  {
    id: "jetstar",
    name: "Jetstar",
